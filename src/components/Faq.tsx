...
const faqs = [
  {
    question: "Как стать партнером Truck-Price?",
    answer: "Чтобы стать партнером Truck-Price, необходимо заполнить форму регистрации на нашем сайте, принять условия партнерского соглашения и пройти простую верификацию. После этого вы получите доступ к личному кабинету и всем инструментам партнерской программы."
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/70 text-lg">
            Всё, что вы хотели узнать о партнерской программе Truck-Price
          </p>
        </div>
