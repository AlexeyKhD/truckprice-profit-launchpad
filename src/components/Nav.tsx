  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed inset-0 bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 transition-all duration-300 z-10 ${
            menuOpen ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
        >
          <a
            href="#how-it-works"
            className="text-xl animated-link"
