...
const steps = [
  ...
  },
  {
    ...
    description: "Рекомендуйте TenChat своим контактам и отслеживайте их активность в CRM-системе",
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/70 text-lg">
            Всего три простых шага отделяют вас от первого заработка в партнерской программе TenChat
          </p>
        </div>
