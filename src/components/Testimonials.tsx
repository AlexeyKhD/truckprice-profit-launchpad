...
const testimonials = [
  {
    ...
    content: "Партнерская программа TenChat превзошла все мои ожидания. За первый месяц я заработал более 150 000 рублей, просто рекомендуя сервис своим бизнес-контактам. Великолепная поддержка и прозрачные выплаты.",
  ...
  },
  {
    ...
    content: "Я скептически относилась к партнерским программам, но TenChat действительно работает. Аналитика, CRM и поддержка на высшем уровне. Мой рекорд - 210 000 рублей за месяц.",
  ...
  },
  {
    ...
    content: "Рекомендую TenChat своим клиентам и при этом получаю стабильный доход. Прозрачная система выплат, никаких задержек. Теперь это значительная часть моего дохода.",
  ...
  },
  {
    ...
    content: "Партнерская программа TenChat идеально вписалась в мой бизнес. Я рекомендую сервис своим клиентам, и они остаются довольны, а я получаю стабильный пассивный доход.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/70 text-lg">
            Узнайте, как партнеры TenChat достигают высоких результатов и получают стабильный доход
          </p>
        </div>
                    ...
                    <div className="md:flex items-stretch">
                      ...
                      <div className="md:w-2/3 p-8 md:p-12 testimonial-card">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <p className="text-white/40 text-sm">Партнер TenChat с 2023 года</p>
                        </div>
                      </div>
                    </div>
                  </div>
