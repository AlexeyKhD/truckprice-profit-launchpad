        ...
        <div className="grid md:grid-cols-2 gap-12 items-center py-12 md:py-24">
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4 max-w-full break-words">
                Станьте партнёром <span className="text-tenchat-red">Truck-Price</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/80 leading-relaxed max-w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button variant="accent" size="lg" withArrow glowing className="text-base py-6 w-full sm:w-auto">
                Начать зарабатывать
              </Button>
              <Button variant="outline" size="lg" className="text-base py-6 w-full sm:w-auto">
                Узнать больше
              </Button>
            </div>
